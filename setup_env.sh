...
export OPENSCENE_DATA_ROOT="/mnt/sdb/DiffusionDrive/dataset"  # Shared data including extra_data/
...
echo "  OPENSCENE_DATA_ROOT=$OPENSCENE_DATA_ROOT (shared: maps, logs, extra_data)"
